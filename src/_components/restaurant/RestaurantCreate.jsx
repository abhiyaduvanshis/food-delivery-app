                    ...
                    <table className="border-collapse border border-gray-300 w-full text-left">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="border border-slate-300 p-2">
                                    <input type="file" name="file" className="w-full" placeholder="Enter the name"/></td>
                            </tr>

                            <tr>
                                <td className="border border-slate-300 p-2">Food Price</td>
                                <td className="border border-slate-300 p-2">
                                    <input name="name" className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter the price"/></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td className="border border-slate-300 p-2">
                                    <input type="submit" name="name" className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Enter the available"/></td>
                            </tr>
